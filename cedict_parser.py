...
class CedictDict:
    ...
    def get_hsk(self, level: int, limit: int = 50, offset: int = 0) -> dict:
        ...
        words_list = HSK_WORDS.get(level, [])
    ...
    def random_words(self, level: int = 0, count: int = 20) -> list[dict]:
        ...
        if level and level in HSK_WORDS:
            pool = HSK_WORDS[level]
